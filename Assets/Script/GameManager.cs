...
public class GameManager : MonoBehaviour
{
    ...
    private void Start()
    {
        ...
        {
            resourceManager = FindObjectOfType<SC_ResourceManager>();
            if (resourceManager == null)
            {
                Debug.LogError("SC_ResourceManager bulunamadı!");
            }
        }

        if (presidentManager == null)
        {
            presidentManager = FindObjectOfType<PresidentManager>();
            if (presidentManager == null)
            {
                Debug.LogError("PresidentManager bulunamadı!");
            }
        }
*/
    }
