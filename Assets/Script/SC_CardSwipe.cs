...
public class SC_CardSwipe : MonoBehaviour
{
    ...
    public void OnPointerUp(BaseEventData data)
    {
        ...
        float distanceY = transform.position.y - initialPosition.y;
        ...
        if (ScriptDice.isSwitched == false)
        {
            if (distanceX >= targetDistance) // Sağda bırakıldıysa
            {
                ...
                // Kartın approveEffect etkisini uygula
                //ScriptResourceManager.ApplyBuildingEffect(ScriptDice.currentCard.approveEffect);
            }
            else if (distanceX <= -targetDistance) // Solda bırakıldıysa
            {
                ...
                // Kartın rejectEffect etkisini uygula
                //ScriptResourceManager.ApplyBuildingEffect(ScriptDice.currentCard.rejectEffect);
            }
        }
